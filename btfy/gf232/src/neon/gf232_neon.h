...
uint32x4_t _gf232_reducex4_neon( uint32x4_t ab0123_low , uint32x4_t ab0123_high )
{
  ...
  poly8x16_t h13 = vreinterpretq_p8_u8(vuzp2q_u8( vreinterpretq_u8_u32(ab0123_high) , vreinterpretq_u8_u32(ab0123_high) ));
  ...
  poly8x16_t h02 = vreinterpretq_p8_u8(vuzp1q_u8( vreinterpretq_u8_u32(ab0123_high) , vreinterpretq_u8_u32(ab0123_high) ));
...
uint32x4_t _gf232_mul4x4_neon( uint32x4_t a_x4 , uint32x4_t b_x4 )
{
  ...
  uint64x2_t ab1   = vreinterpretq_u64_p128( vmull_high_p64(vreinterpretq_p64_u64(a0_a1),vreinterpretq_p64_u64(b0_b1)) );
  uint64x2_t ab2   = vreinterpretq_u64_p128( vmull_p64((poly64_t)vdupd_laneq_u64(a2_a3,0),(poly64_t)vdupd_laneq_u64(b2_b3,0)) );
  uint64x2_t ab3   = vreinterpretq_u64_p128( vmull_high_p64(vreinterpretq_p64_u64(a2_a3),vreinterpretq_p64_u64(b2_b3)) );
  uint32x4_t ab01  = vreinterpretq_u32_u64(vzip1q_u64(ab0,ab1));
  uint32x4_t ab23  = vreinterpretq_u32_u64(vzip1q_u64(ab2,ab3));
