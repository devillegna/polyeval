...
uint32x4_t _gf232_reducex4_neon( uint32x4_t ab0123_low , uint32x4_t ab0123_high )
{
  ...
  uint8x16_t h13 = vuzp2q_u8( ab0123_high , ab0123_high );
  ...
  uint8x16_t h02 = vuzp1q_u8( ab0123_high , ab0123_high );
  ab0123_low ^= vmull_p8( vget_low_p8(h02) , _0x8d );
  return ab0123_low;
}
...
uint32x4_t _gf232_mul4x4_neon( uint32x4_t a_x4 , uint32x4_t b_x4 )
{
  ...
  uint64x2_t ab0   = vreinterpretq_u64_p128( vmull_p64(vget_low_u64(a0_a1),vget_low_u64(b0_b1)) );
  uint64x2_t ab1   = vreinterpretq_u64_p128( vmull_high_p64(a0_a1,b0_b1) );
  uint64x2_t ab2   = vreinterpretq_u64_p128( vmull_p64(vget_low_u64(a2_a3),vget_low_u64(b2_b3)) );
  uint64x2_t ab3   = vreinterpretq_u64_p128( vmull_high_p64(a2_a3,b2_b3) );
  uint64x2_t ab01  = vzip1q_u64(ab0,ab1);
  uint64x2_t ab23  = vzip1q_u64(ab2,ab3);
