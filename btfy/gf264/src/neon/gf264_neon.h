...
uint64_t _gf264_mulx1_neon( uint64_t a , uint64_t b )
{
  ...
  uint64x2_t ab0 = vreinterpretq_u64_p128( vmull_p64(vdup_n_u64(a),vdup_n_u64(b)) );
  // reduce
  uint64x2_t ab1r = vreinterpretq_u64_p128( vmull_high_p64(ab0,mask_0x1b) );  // X,XXXXXXXX XXXXXXXX  <-- 3bits in the high 64bits

  uint64x2_t r0 = ab0 ^ ab1r ^ vmulq_p8(vtrn2q_u64(ab1r,ab1r),mask_0x1b);  // only low 64 bits is meaningful
